...
then
    pacman -S git rofi lf xorg xorg-xinit base base-devel wget ntp feh picom calcurse nerd-fonts gnu-free-fonts ttf-font-awesome noto-fonts-emoji ttf-iosevka-nerd --noconfirm
    cd
